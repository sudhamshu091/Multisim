	...
	; Compiler options:
	;
	; --ASMLIST -G -M -N255 -P --OPT=none --CHIP=16F84A \
	; --ERRFORMAT=error; file %f; line %l; column %c; %s \
	; --WARNFORMAT=warning; file %f; line %l; column %c; %s \
	; --MSGFORMAT=message; file %f; line %l; column %c; %s \
